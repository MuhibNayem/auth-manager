...
from tessera.errors import IntegrityError, NotFoundError

logger = logging.getLogger("tessera.organizations")
...
INVITE_RATE_LIMIT_KEY_TEMPLATE = "tessera:ratelimit:orginvite:{org_id}"
...
class OrganizationManager:
    ...
    async def _enforce_invitation_rate_limit(self, org_id: str) -> None:
        ...
        if count > self._max_invites_per_window:
            from tessera.errors import RateLimitError
