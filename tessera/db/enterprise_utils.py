"""
Production-Ready Database Utilities for Enterprise Tessera.
...
from tessera.errors import DatabaseError

logger = logging.getLogger("tessera.db.enterprise_utils")
