...
- All failures raise :class:`authy_package.errors.AuthyError` subclasses —
...
logger = logging.getLogger("authy.cognito")
...
def _raise_cognito_error(exc: Exception, context: str) -> None:
    """Translate a boto3 ClientError into an AuthyError subclass."""
        ...
        *,
        ...
        if not BOTO3_AVAILABLE:
            raise ImportError(
                ...
                "authy-package with the corresponding extra"
            )
