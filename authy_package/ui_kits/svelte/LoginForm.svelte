		...
		{:else}
			...
			{#if showSocial}
				<div class="authy-social-grid">
					<button type="button" class="authy-social-btn google" on:click={() => handleSocialLogin('google')}>
					...
					<button type="button" class="authy-social-btn github" on:click={() => handleSocialLogin('github')}>
