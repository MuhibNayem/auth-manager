...
mirror :class:`~authy_package.db.memory.InMemoryDatabase`:
...
from authy_package.errors import DatabaseError, IntegrityError
...
logger = logging.getLogger("authy.db.sql")
