# Tessera RBAC — Status Report (2.0 remediation)
...
|---|---|---|
| Core RBAC engine | `tessera/admin/rbac_manager.py` | Delivered (rebuilt) |
| REST endpoints | `tessera/admin/rbac_api.py` | Delivered (rebuilt) |
| React role manager UI | `tessera/ui_kits/react/admin-dashboard/src/components/RBACManager.tsx` | Delivered (rebuilt) |
...
```python
from tessera.admin.rbac_manager import RBACManager, PermissionScope
